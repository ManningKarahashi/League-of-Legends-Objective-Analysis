...
To summarize overall neutral-objective control, I created a new feature called `total_objectives`, defined as the sum of dragons, heralds, barons, elders, and atakhans per team.
